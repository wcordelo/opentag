...
file lists and gap statements are not current status. They are retained under
[`archive/`](./archive/):

| Document | Historical role |
| --- | --- |
| [archive/ARCHITECTURE-ANALYSIS.md](./archive/ARCHITECTURE-ANALYSIS.md) | Pre-implementation architecture analysis |
| [archive/SPEC.md](./archive/SPEC.md) | A1–A5 implementation specification |
| [archive/GOAL.md](./archive/GOAL.md) | Autonomous implementation plan |
| [archive/implementation-notes.md](./archive/implementation-notes.md) | Chronological phase log and later corrections |
| [archive/ANALYSIS-SUMMARY.txt](./archive/ANALYSIS-SUMMARY.txt) | Original migration decision summary |
...
The current [VISION-SPEC.md](./VISION-SPEC.md), [ROUTER-SPEC.md](./ROUTER-SPEC.md),
