...
| Bot deployment | `opentag-bot`, version `b7cc41a4-2d22-4ede-b7e9-0661ec216c63` — deployed from merged main `498164f` after typecheck, unit, Worker/e2e, deploy-config, and Wrangler dry-run validation |
