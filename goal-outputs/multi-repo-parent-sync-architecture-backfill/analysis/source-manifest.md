...
>
> This is a point-in-time ancestry and automation manifest. Its repository heads and OpenTag dirty-tree snapshot remain valid historical evidence; use `CURRENT-STATE-RECONCILIATION.md` for current OpenTag source/deployment evidence.
