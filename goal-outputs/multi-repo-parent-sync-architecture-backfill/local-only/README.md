...
>
> This local synthesis is historical. The current implementation and evidence are reconciled in `CURRENT-STATE-RECONCILIATION.md` and `docs/current-state.md`; the former “Layer 3 not started” and “no deployment” wording is point-in-time, not current.
