...
>
> Current reconciliation: the portable Centaur runtime identity, delivery, harness, platform, and router lessons are reflected in current OpenTag docs and live evidence. Centaur's Kubernetes/Rails/Postgres and extra product surfaces remain not applicable.
