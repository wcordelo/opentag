...
>
> This local source manifest is a historical snapshot. Do not use its OpenTag commit/deployment statements as current authority; use `CURRENT-STATE-RECONCILIATION.md`.
